...
module.exports = {
  up: async ( queryInterface, Sequelize ) => {
    return await queryInterface.bulkInsert( "Edits", [
      { content: "Article 1, test edit 1", current: false, createdAt: new Date(), updatedAt: new Date(), articleId: 1 },
      { content: "Article 1, test edit 2", current: true, createdAt: new Date(), updatedAt: new Date(), articleId: 1 },
